 ...
 * Description:طرح های خود را بالا ببرید و قدرت کامل المنتور را باز کنید. به ده ها ویجت و کیت حرفه ای، تم ساز، پاپ آپ، فرم ها و قابلیت های ساخت ووکامرس دسترسی پیدا کنید.
 * Plugin URI: https://flatsomee.ir
 * Author: ایران فلتسام
 * Version: 3.20.3
 * Elementor tested up to: 3.20.0
 * Author URI: ایران فلتسام
 *
...
$myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
	'https://dl.flatsomee.ir/sources/plugins/elementor-pro/skfioepwdkdpow.json',
	__FILE__,
	'elementor-pro'
);

...
add_ux_builder_shortcode( 'testimonial', array(
    ...
    'presets' => array(
        ...
        array(
          'name' => __( 'ردیف - تصویر چپ' ),
          'content' => '[row] [col span="6" span__sm="12"] [testimonial image="9147" image_width="121" name="ایمان عربی نوده" company="ایران فلتسام"] <p>لذت خرید از ایران فلتسام، محصول با کیفیت، پشتیبانی سریع و...</p> [/testimonial] [/col] [col span="6" span__sm="12"] [testimonial image="9149" image_width="121" name="Mark Jance" company="Facebook"] <p>This is a FANTASTIC Theme. Do you think that in the next version you could try and have it Multilanguage. Because I have nothing bad to say about this theme. Thank a million!</p> [/testimonial] [/col] [/row]'
        ),
         array(
          'name' => __( 'ردیف - تصویر بالا' ),

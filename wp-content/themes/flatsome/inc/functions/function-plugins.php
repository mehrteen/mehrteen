...
function flatsome_register_required_plugins() {
	...
	$config = array(
		...
		'strings'      => array(
			'page_title'                      => __( 'افزونه های ضروری', 'tgmpa' ),
			'menu_title'                      => __( 'نصب افزونه ها', 'tgmpa' ),
			'installing'                      => __( 'در حال نصب : %s', 'tgmpa' ), // translators: %s = plugin name.
			...
			'install_link'                    => _n_noop( 'شروع نصب افزونه ها', 'Begin installing plugins' ),
			'activate_link'                   => _n_noop( 'شروع فعال سازی افزونه ها', 'Begin activating plugins' ),
			'return'                          => __( 'بازگشت به بخش نصب افزون ها', 'tgmpa' ),
			'plugin_activated'                => __( 'افزونه با موفقیت فعال شد.', 'tgmpa' ),
			'complete'                        => __( 'تمامی افزونه ها با موفقیت نصب و فعال شدند. %s', 'tgmpa' ), // %s = dashboard link.

...
Flatsome_Option::add_section( 'type',
	array(
		'title' => __( 'تایپوگرافی', 'flatsome-admin' ),
		'panel' => 'style',
	)
);
...
Flatsome_Option::add_field( 'option',
	array(
		...
		'label'    => __( 'فونت های گوگل را غیرفعال کنید. هیچ فونتی از گوگل بارگیری نمی شود.', 'flatsome-admin' ),
		'section'  => 'type',
		'default'  => 0,
	)
);
...
Flatsome_Option::add_field( 'option',
	array(
		...
		'label'       => __( 'بارگذاری فونت ها از CDN', 'flatsome-admin' ),
		'description' => '<strong>با توجه به محدودیت ها، تنظیم این مورد توصیه نمی شود.</strong> <a href="https://docs.uxthemes.com/article/415-google-fonts" target="_blank" rel="noopener noreferrer">اطلاعات بیشتر</a>',
		'section'     => 'type',
		'default'     => 0,
...
Flatsome_Option::add_field( 'option',
	array(
		...
		'label'       => __( 'تایپ نمایش فونت های گوگل', 'flatsome-admin' ),
		'description' => 'نحوه نمایش فونت های گوگل را انتخاب کنید.',
		'tooltip'     => '<ul>

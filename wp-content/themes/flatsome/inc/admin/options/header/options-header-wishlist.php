 ...
 *************/
  ...
  Flatsome_Option::add_section( 'header_wishlist', array(
    'title'       => __( 'علاقمندی ها', 'flatsome-admin' ),
    'panel'       => 'header',
    'priority' => 110,
  ) );
  ...
  Flatsome_Option::add_field( 'option', array(
    ...
    'label'       => __( 'آیکون علاقمندی ها', 'flatsome-admin' ),
    'transport' => $transport,
  ...
  Flatsome_Option::add_field( 'option',  array(
    ...
    'label'       => __( 'نمایش عنوان علاقمندی ها', 'flatsome-admin' ),
  ...
  Flatsome_Option::add_field( 'option',  array(
    ...
    'label'       => __( 'عنوان سفارشی', 'flatsome-admin' ),
    'section'     => 'header_wishlist',
    'transport' => $transport,
    'default'     => '',
  ));

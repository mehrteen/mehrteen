<div class="wrap" id="of_container">
	...
	<div id="of-popup-save" class="of-save-popup">
		<div class="of-save-save">تنظیمات قالب بروزرسانی شدند.</div>
	</div>
	
	<div id="of-popup-fail" class="of-save-popup">
		<div class="of-save-fail">خطا!</div>
	</div>
	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="main">
			...
			<div id="of-nav">
				...
				<div class="logo">
					<h2>ایـــــــران فــــــــلتسام<span><?php echo ('نسخه : '. THEMEVERSION); ?></span></h2>
				</div>
					<div class="save_bar"> 
						<button id ="of_save" type="button" class="button-primary"><?php _e('ذخیره همه تغییرات', 'flatsome-admin');?></button>			
				...
				<div style="padding:18px">
					<a href="<?php echo get_admin_url().'customize.php'; ?>" class="button-secondary">سفارشی سازی &rarr;</a>
				</div>
			...
			<div id="content">
	  			...
	  			<div class="save_bar" style="padding-left:0;"> 
					...
					<button id="of_save" type="button" class="button-primary"><?php _e('دخیره تنظیمات', 'flatsome-admin');?></button>
					<img style="display:none" src="<?php echo ADMIN_DIR; ?>assets/images/loading-bottom.gif" class="ajax-loading-img ajax-loading-img-bottom" alt="Working..." />

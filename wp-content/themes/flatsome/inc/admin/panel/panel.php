...
class Flatsome_Admin {
	...
	public function flatsome_panel_register_menu() {
		...
		add_menu_page( 'Welcome to Flatsome', 'ایران فلتسام', 'manage_options', 'flatsome-panel', array( $this, 'flatsome_panel_welcome' ), get_template_directory_uri() . '/assets/img/logo-icon.svg', '2' );
		add_submenu_page( 'flatsome-panel', 'Theme Registration', 'لایسنس', 'manage_options', 'admin.php?page=flatsome-panel' );
		add_submenu_page( 'flatsome-panel', 'Help & Guides', 'مستندات', 'manage_options', 'flatsome-panel-support', array( $this, 'flatsome_panel_support' ) );
